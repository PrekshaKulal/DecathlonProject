...
function Login() {
 ...
 try {
    const res = await axios.post(`${import.meta.env.VITE_API_URL}/check-user`, {
      email: email
    });
...
<form onSubmit={handleSubmit}>
          <div className="main">
            ...
            <span className={!showEmail ? "active" : ""} onClick={() => setShowEmail(false)} > Phone number </span>
          </div>
          {showEmail ? (
            <>
